          ...
          <section className="flex flex-col items-center gap-6">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/80 p-8 text-center shadow-xl">
              ...
              <p className="mb-6 max-w-md leading-relaxed text-slate-300">
                ...
                Ele utiliza React no Frontend e uma API construída em Django conectada à IA do Google Gemini para gerar perguntas dinâmicas e corrigir as respostas em tempo real. Seja bem-vindo e divirta-se testando seus conhecimentos bíblicos!
              </p>
              <button
